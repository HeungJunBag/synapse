...
- docs/DOMAIN-NOTE-CONSTITUTION.md : 노트 도메인 원칙
- docs/DOMAIN-NOTE-STATUTE.md : 노트 도메인 규칙

---

## 기록

- docs/AI-ACTION-LOGS.md : 최근 작업 로그, 최대 100개 유지 (매 세션 시작 시 100개 초과 시 오래된 순으로 삭제)
